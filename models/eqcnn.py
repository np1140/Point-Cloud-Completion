...
class EQCNN_cls(nn.Module):
    def __init__(self, k=20, pooling='mean', output_channels=128, add_x_norm=None, no_mean=False):
        ...
        self.conv6 = nn.Conv1d(2046, 128, kernel_size=1, bias=False)
    ...
    def forward(self, x):
        ...
        coor_q, f_q = self.fps_downsample(coor, x, 128)
        coor = coor_q
